...
Current application release: **1.3.1**.
...
power meters, plus local network endpoints such as the Xerox B235 printer.
...
Deferred operational checks are tracked in the [task list](docs/teendok.md).
